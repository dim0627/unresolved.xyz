...
export type Career = Entity & Node & {
  __typename?: 'Career';
...
export type ScheduledOperationAffectedDocument = Asset | Career | Profile | Project;
...
export type IndexQueryQuery = { __typename?: 'Query', profiles: Array<(
    { __typename?: 'Profile' }
